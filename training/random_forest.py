...
def plot_topk_rf_importances(model: RandomForestClassifier,
                             feature_names: pd.Index,
                             k: int = 15,
                             out_dir: str = "results/figures",
                             filename: str = "rf_importances.png"):
    """Save a horizontal bar chart with top-k RandomForest feature importances."""
    _ensure_dir(out_dir)
...
def main():
    ...
    plot_topk_rf_importances(
        model, X.columns, k=15,
        out_dir="results/figures",
        filename="rf_importances.png"
    )
    ...
    save_submission(preds_test_codes, user_categories, out_csv="results/submissions/submission_rf.csv")
